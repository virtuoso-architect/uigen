          ...
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={35} minSize={25} maxSize={50}>
              <div className="h-full flex flex-col bg-white">
                {/* Chat Header */}
                <div className="h-14 flex items-center px-6 border-b border-blue-950 bg-blue-900">
            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                {/* Top Bar */}
                <div className="h-14 border-b border-blue-950 px-6 flex items-center justify-between bg-blue-900">
                  <Tabs
                    value={activeView}
                    onValueChange={(v) =>
